...
public class ViewerContainer2D extends ViewerContainer{
	...
	protected void mousePressed(int ex, int ey, int button) {
		...
		catch(Exception ee)
		{
            ...
            ((Viewer2D)viewer).mousepressed(ex,ey, button);
	...
	protected void mouseReleased(int ex, int ey, int button)
	{
		...
		catch(Exception ee)
		{
            ...
            ((Viewer2D)viewer).mousereleased(ex,ey, button);
	...
	protected void mouseDragged(int ex, int ey) {
       ...
       this.render();
		...
		catch(Exception ee)
		{
            ...
            ((Viewer2D)viewer).mousedragged(0,0, 0, 0);
	...
	/*	if (((Viewer2D)viewer) == null)
		...
		catch(Exception ee)
		{
            ...
            ((Viewer2D)viewer).mousemoved(ex,ey);
